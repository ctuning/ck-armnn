...
int main(int argc, char* argv[]) {
    ...
    string input_layer_name         = getenv_s("CK_ENV_ONNX_MODEL_INPUT_LAYER_NAME");
    string output_layer_name        = getenv_s("CK_ENV_ONNX_MODEL_OUTPUT_LAYER_NAME");
    ...
    try {
        ...
        measure_setup([&]{
            ...
            armnnOnnxParser::BindingPointInfo inputBindingInfo = parser->GetNetworkInputBindingInfo(input_layer_name);
            armnnOnnxParser::BindingPointInfo outputBindingInfo = parser->GetNetworkOutputBindingInfo(output_layer_name);
